...
jr_000_0d82::
	...
	inc de                                        ; .. Tile number
	inc de                                        ; .. Flags
	inc de                                        ; .. Next OAM entry
	dec b                                         ; 
	 jr nz, jr_000_0d82                           ; Repeat 4 times
...
PlayGameIntro::
	ld a, [wAnimationStarted]                     ; Check if the animation has been initialized/started
